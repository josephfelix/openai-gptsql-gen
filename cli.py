...
if __name__ == '__main__':
    ...
    query_temperture = 0.1
    prompt = input('Enter prompt to generate SQL query: ')
    final_prompt = f'Given an input question, respond with syntactically correct MySQL. Be creative but the SQL must be correct, not nessesary to use all tables.\n\n{sql_schema}\n\nInstructions: {prompt}\n\nSQL:\n'
